...
class FeedMessageTest{
    ...
    fun testOutcomeMessage(){
        ...
        val expected = Outcome("b839be63-5e4e-44d4-98e4-8660eedf0bcc","49add731-8e63-4307-8d44-d916b9108c0d","\\|MK Dons\\| 0-3","1/500",true,false)
        assertEquals(expected,actual)
    }
    ...
    fun testMarketMessage(){
        ...
        val expected = Market("f304489c-f75b-496f-ade1-4c87d46852eb","b6e00f34-efec-49ee-a618-9d3c6e982af5","Goal Handicap (-1)",true,false)
        assertEquals(expected,actual)
    }
